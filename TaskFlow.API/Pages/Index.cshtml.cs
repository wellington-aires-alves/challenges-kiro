...
public class IndexModel : PageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        Console.WriteLine($"[DEBUG] OnGetAsync - UserId: {userId}, Tasks Count: {Tasks.Count()}");
    ...
    {
        Console.WriteLine("========================================");
        Console.WriteLine("[DEBUG] Index (RAIZ) OnPostAsync CHAMADO!");
        Console.WriteLine("========================================");
    ...
    {
        Console.WriteLine("========================================");
        Console.WriteLine("[DEBUG] Index (RAIZ) OnPostCreateAsync CHAMADO!");
        Console.WriteLine("========================================");
        ...
        try
        {
            ...
            // Debug: Log para verificar
            Console.WriteLine($"[DEBUG] OnPostCreateAsync - UserId: {userId}, Task Created: {createdTask.Id}");
            ...
            // Debug: Log para verificar
            Console.WriteLine($"[DEBUG] OnPostCreateAsync - Tasks reloaded, Count: {Tasks.Count()}");
        ...
        {
            Console.WriteLine($"[ERROR] OnPostCreateAsync - {ex.Message}");
